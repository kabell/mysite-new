...
else if(x-n>0) pole[x-n][1].dolezac=true;
else if(x+n<=r) pole[x+n][1].horezac=true;
else if(y-n>0) pole[1][y-n].dolezac=true;
else if(y+n<=s) pole[1][y+n].horezac=true;
else pole[1][1].dolezac=true;
}
