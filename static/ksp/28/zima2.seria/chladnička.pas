...
for i:=1 to pocet do begin {naèítavanie vstupov a zaznamenanie poètov 1, 2, 3}
read(rad[i]);
...
readln;
if a >= 1 then begin {Ak existuje aspoò jedna 1}
for i:=1 to a do begin

if rad[i]=2 then begin {Ak je namiesto 1 dvojka}
x:=a;{h¾adá sa medzi 2 a potom medzi 3}
...
x:=a+b;{H¾adá sa najskôr medzi 3}
repeat
x:=x+1;
...
if b >= 1 then begin {Ak existuje aspoò jedna 2}
for i:=a+1 to b+a do begin {H¾adajú sa 3 ktoré sú namiesto 2}
